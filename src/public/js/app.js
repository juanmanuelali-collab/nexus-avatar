...
function showResult(gen) {
  ...
  state.compareImages = {
    before: gen.input_image_url || gen.output_image_url,
    after: gen.output_image_url,
  };
...
// a la URL de Supabase — cross-origin, el atributo "download" del navegador
// no funciona ahí y termina navegando fuera de la app.
