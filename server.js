...
app.get('/api/voices', auth, (req, res) => {
  res.json({
    voices: [
      { id: 'aria',    name: 'Aria',    gender: 'F' },
      { id: 'sarah',   name: 'Sarah',   gender: 'F' },
      { id: 'laura',   name: 'Laura',   gender: 'F' },
      { id: 'jessica', name: 'Jessica', gender: 'F' },
      { id: 'emma',    name: 'Emma',    gender: 'F' },
      { id: 'alice',   name: 'Alice',   gender: 'F' },
      { id: 'lily',    name: 'Lily',    gender: 'F' },
      { id: 'matilda', name: 'Matilda', gender: 'F' },
      { id: 'river',   name: 'River',   gender: 'N' },
      { id: 'liam',    name: 'Liam',    gender: 'M' },
      { id: 'will',    name: 'Will',    gender: 'M' },
      { id: 'eric',    name: 'Eric',    gender: 'M' },
      { id: 'brian',   name: 'Brian',   gender: 'M' },
      { id: 'adam',    name: 'Adam',    gender: 'M' },
      { id: 'charlie', name: 'Charlie', gender: 'M' },
      { id: 'george',  name: 'George',  gender: 'M' },
      { id: 'callum',  name: 'Callum',  gender: 'M' },
      { id: 'chris',   name: 'Chris',   gender: 'M' },
      { id: 'daniel',  name: 'Daniel',  gender: 'M' },
      { id: 'ethan',   name: 'Ethan',   gender: 'M' },
      { id: 'fin',     name: 'Fin',     gender: 'M' },
    ],
    languages: [
      { id: 'es', name: '🇦🇷 Español' },
      { id: 'en', name: '🇺🇸 English' },
